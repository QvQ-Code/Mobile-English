<?php 
	...
	if (isset($_POST["add-sentence"])) {
		...
		$execute = $db->query("INSERT INTO `site_sentence` (`sentence_id`, `sentence`, `keyword`) VALUES (NULL, '$sentence', '$keyword')");
...
<div class="main-wrapper">
	...
	<form action="" method="POST">
		...
		<div class="form-group">
			<label>1</label>
			<input type="text" name="sentence" placeholder="Type here . ." required>
		</div>
		<div class="form-group">
